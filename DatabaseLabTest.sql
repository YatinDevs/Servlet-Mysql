...
-- Create a word file. Save it by your name and section. Write the solution for every question with snapshot. --
-- Use the HRMS schema.\ --


-- 1. Display  the last name and salary for all employees whose salary is not in the range of 5,000 and 12,000. --

select last_name,salary from employees
where salary not between 5000 and 12000;

-- 2.  Display the employee last name, job ID, and start date of employees hired between February 20, 1998, and May 1, 1998.--

select last_name,job_id,hire_date from employees
where hire_date between '1998-02-20' and '1998-05-01' ORDER BY hire_date;

-- 3. Display the last name and department number of all employees in departments 2 and 5 in alphabetical order by name.
...
-- 5.  Create a query that displays employee last names, department numbers, and all the employees who work in the same department as a given employee. Give each column an appropriate label. 
...
-- 6. Create a query that displays employee last names, job title, and city of all the employees who work in the same city as a given employee. Give each column an appropriate label.
...
-- 7. Display the names of all employees who earn less than the average salary in the company.
...
-- 8. .Display employees who are not IT programmer and whose salary is more than any of the IT-programmer..
select employees.last_name,employees.salary,
employees.job_id,jobs.job_title as "Job" 
from employees    natural join jobs
WHERE job_id NOT IN (9)
AND salary >  ('IT_PROG');

-- 9. Display the name of the employee with highest salary
select first_name,last_name,max(salary) from employees;

-- 10. Display the employee last names, salaries, department numbers, and average salaries for all the employees who earn more than the average salary in their department.
